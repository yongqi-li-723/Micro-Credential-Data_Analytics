...
SELECT E.FIRSTNAME, E.LASTNAME, D.GENDER, D.BIRTHDATE 
FROM DEPENDENTS D
...
SELECT E.EMPLOYEEID, E.FIRSTNAME, E.LASTNAME, E.TITLE, M.FIRSTNAME, M.LASTNAME, M.TITLE
FROM EMPLOYEES E
...
SELECT E.EMPLOYEEID, E.FIRSTNAME, E.LASTNAME, D.DEPARTMENTNAME, D.GROUPNAME, ED.STARTDATE, ED.ENDDATE
FROM EMPLOYEES E
...
SELECT E.EMPLOYEEID, E.FIRSTNAME, E.LASTNAME, A.ADDRESSLINE1, A.ADDRESSLINE2, A.CITY, A.STATE, A.ZIP1, A.ZIP2, D.DEPARTMENTNAME, D.GROUPNAME, ED.STARTDATE, ED.ENDDATE
FROM EMPLOYEES E
INNER JOIN EMPLOYEESDEPARTMENTS ED ON E.EMPLOYEEID = ED.EMPLOYEEID
INNER JOIN DEPARTMENTS D ON ED.DEPARTMENTID = D.DEPARTMENTID
...
LEFT OUTER JOIN DEPARTMENTS D ON ED.DEPARTMENTID = D.DEPARTMENTID
...
RIGHT OUTER JOIN DEPARTMENTS D ON ED.DEPARTMENTID = D.DEPARTMENTID
...
INNER JOIN EMPLOYEESDEPARTMENTS ED ON E.EMPLOYEEID = ED.EMPLOYEEID
INNER JOIN DEPARTMENTS D ON ED.DEPARTMENTID = D.DEPARTMENTID
WHERE UPPER(DEPARTMENTNAME) = 'MARKETING'
